...
struct Faces
{
	...
	/*!each face can have a maximum of 100 vertices*/
...
bool checkLoop(int x1, int x2, int y1, int y2, int z1, int z2) {
	/*!this checks the loop and thus gives a signal whenever a face is complete*/
...
void addFace() {
	/*!this adds faces to the final list, whenever user is done drawing a face*/
...
void selView(int x)
{
	/*! toggles between wireframe view and solid view*/
...
void drawFaces()
{
	/*! this displays the faces on the window*/
	int i;
...
void theCube()
{
	/*! the function for a small pointer cube that helps in drawing*/
	glPushMatrix();
	glColor3f(1, 1, 1);
...
void drawGrid()
{
	/*! this draws the grid to which help in drawing*/
	int i;
	for (i = 0; i < 30; i++)
	{
		glPushMatrix();
...
void project() {
	/*! this helps in changing the perspective of vision*/
...
void display()
{
	/*! the function to display the final output*/
...
{
	/*! to take inputs from the keyboard*/
